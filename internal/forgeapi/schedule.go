...
// Schedule is the Forge wire-level Schedule. Forge schedules attach to
// any "unified job template" (JobTemplate, WorkflowJobTemplate,
// ProjectUpdate, InventoryUpdate, SystemJob). MVP supports JobTemplate.
//
// ExtraData is RawMessage because Forge accepts a YAML/JSON string on
...
// CreateSchedule attaches a schedule to a JobTemplate. Forge accepts
