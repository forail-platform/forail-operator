...
// CredentialType is the Forge wire-level CredentialType (read-only from
// the operator's perspective — built-ins are populated by Forge).
...
// Credential is the Forge wire-level Credential.
