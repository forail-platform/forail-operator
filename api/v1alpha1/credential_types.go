...
// CredentialSpec defines the desired state of a Forail Credential.
...
// CredentialStatus reflects the observed Forail state.
...
// +kubebuilder:resource:shortName=cred,categories=forail
